...
class _SyncSessionService(Protocol):
    ...
    def disconnect(self, **params: Any) -> Any: ...
    def keepalive(self, **params: Any) -> Any: ...


class _AsyncSessionService(Protocol):
    async def connect(self, **params: Any) -> Any: ...
    async def disconnect(self, **params: Any) -> Any: ...
    async def keepalive(self, **params: Any) -> Any: ...
